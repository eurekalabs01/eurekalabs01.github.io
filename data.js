...
const TEAM = [
  ...
  { group: "pi", name: "Zhipeng Cai",     role: "Lead Principal Investigator", affiliation: "Georgia State University", honors: "Distinguished University Professor, IEEE Fellow, AAIA Fellow",   image: "team/cai.jpg",       url: "https://cas.gsu.edu/profile/zhipeng-cai/" },
  ...
  { group: "collaborator", name: "Michael Faggella-Luby", role: "Collaborator", affiliation: "Texas Christian University", image: "team/faggella-luby.jpg", url: "https://coe.tcu.edu/about/faculty-staff/view/michael-faggella-luby" },
  ...
  { group: "hidden", name: "Wei Cheng",   role: "Collaborator", affiliation: "University of Washington Tacoma", image: "team/weicheng.jpg", url: "https://faculty.washington.edu/uwcheng/" },
  ...
  { group: "former", name: "Blake Lucas",     role: "Research Assistant", affiliation: "Senior Software Engineer, Ford Credit", image: null, url: "https://www.linkedin.com/in/blake-lucas-56b01a16a/" },
  ...
  { group: "former", name: "Emma Beebe",         role: "Research Assistant", affiliation: "Software Engineer, AWS",                   image: "team/emma.jpg",  url: "https://www.linkedin.com/in/e-bee/" },
  ...
  { group: "ra", name: "Grace Moore",          role: "Research Assistant", affiliation: "Miami University", image: "team/grace.jpg",      url: "https://www.linkedin.com/in/gracemoore22" },
];
...
const LABS = [
...

  {
    ...
    image: "labs/model-inversion/cover.jpg",
...

  {
    ...
    title: "From Odds to Action: Practicing Logistic Regression",
    categories: ["ai"], level: ["fundamental"],
    authors: "Liran Ma, Zhipeng Cai",
    ...
    image: "labs/logistic-regression/Logistic_Regression.jpg",
    pdf:   "labs/logistic-regression/Logistic_Regression.pdf",
    updated: "2026-04-26", estimatedTime: "2-3 hours",
    resources: [
      { label: "Notebook (logistic_regression.ipynb)", url: "labs/logistic-regression/logistic_regression.ipynb" },
    ],
  },

  {
    ...
    image: "labs/backdoor-attacks/cover.jpg",
...

  {
    ...
    image: "labs/membership-inference/cover.jpg",
...

  {
    ...
    image: "labs/data-poisoning/cover.jpg",
...

  {
    ...
    image: "labs/adversarial-attacks/cover.jpg",
...

  {
    ...
    image: "labs/data-cleaning/cover.jpg",
...

  {
    ...
    image: "labs/emotion-cnn/cover.jpg",
...

  {
    ...
    image: "labs/feature-scaling/cover.jpg",
...

  {
    ...
    image: "labs/regression-face/cover.jpg",
    pdf:   "labs/regression-face/Regression.pdf",
    updated: "2025-08-15", estimatedTime: "3-5 hours",
    resources: [
      { label: "Notebook — CNN method (Reg_CNN_method.ipynb)",  url: "labs/regression-face/Reg_CNN_method.ipynb" },
      { label: "Notebook — HOG method (Reg_HOG_method.ipynb)",  url: "labs/regression-face/Reg_HOG_method.ipynb" },
      { label: "Notebook — PCA method (Reg_PCA_method.ipynb)",  url: "labs/regression-face/Reg_PCA_method.ipynb" },
    ],
  },

  {
    id: "svm-showdown",
    title: "Draw the Line: An SVM Showdown",
    categories: ["ai"], level: ["fundamental", "advanced"],
    authors: "Liran Ma, Zhipeng Cai",
    ...
    image: "labs/svm-showdown/cover.jpg",
    pdf:   "labs/svm-showdown/SVM.pdf",
    updated: "2025-07-03", estimatedTime: "3-4 hours",
    resources: [
      { label: "Notebook (svm.ipynb)", url: "labs/svm-showdown/svm.ipynb" },
    ],
  },

  {
    id: "cereal-pca",
    title: "The Cereal Selection Puzzle: PCA Unmasks Healthy Cereals",
    categories: ["ai"], level: ["fundamental"],
    ...
    image: "labs/cereal-pca/cover.jpg",
...

  {
    ...
    image: "labs/intruder-hunt/intruder-hunt.jpg",
...

  {
    ...
    image: "labs/walls-have-ears/walls-have-ears.jpg",
...

  {
    ...
    image: "labs/video-aficionado/video-aficionado.jpg",
...

  {
    ...
    image: "labs/enhanced-open/wpa3-owe.jpg",
...

  {
    ...
    image: "labs/ethereum/Ethereum.jpg",
